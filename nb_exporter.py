...
def get_export_contents(images: List[Dict], prefix: str, output_dir: str) -> Dict:
    ...
    for image_dict in images:
        ...
        filename = "{}_cell_{}_output_{}.{}".format(prefix, image_dict["cell_idx"], image_dict["output_idx"], file_ext)
...
def export_images(filepath: str, output_dir: Optional[str] = None, prefix: Optional[str] = None) -> Dict:
